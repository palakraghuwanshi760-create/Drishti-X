...
import type { NavigationPage, Language } from '../types';
        ...
        <div className="space-y-6">
          ...
          <div>
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-teal-700 hover:bg-teal-800 text-white font-semibold rounded-xl shadow-sm transition-all hover:shadow-md cursor-pointer text-sm"
            >
          ...
          >
            {navItems.map((item) => {
              ...
              const isActive = item.activePages.includes(
                currentPage
              );
        ...
        <div className="space-y-3 pt-4 border-t border-slate-100">
          ...
          <div className="bg-slate-50 p-3 rounded-xl border border-slate-100">
            <div className="flex items-center gap-1.5 text-xs font-semibold text-slate-800 mb-1">
              ...
              <span>NetraRakshak AI Prototype</span>
            </div>

            <p className="text-[11px] text-slate-500 leading-normal">
              Explainable Grad-CAM heatmaps for community
              eye-care screening.
            </p>
          </div>
